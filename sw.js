const CACHE='universe-invoice-v0.14.18';
const DEP_CACHE='universe-invoice-dependencies-v2';
const LOCAL_ASSETS=['./','./index.html','./styles.css?v=0.14.18','./app.js?v=0.14.18','./manifest.webmanifest?v=0.14.18','./icon.svg','./icon-192.png','./icon-512.png'];
